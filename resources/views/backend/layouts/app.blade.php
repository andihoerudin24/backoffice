...
<body>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item {{ Route::is('group.index') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('group.index') }}">
                                <span class="feather-icon"><i data-feather="list"></i></span>
                                <span class="nav-link-text">Group</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Route::is('listgroup.index') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('listgroup.index') }}">
                                <span class="feather-icon"><i data-feather="settings"></i></span>
                                <span class="nav-link-text">List Group</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <script src="{{ asset('vendors/popper.js/dist/umd/popper.min.js') }}"></>
